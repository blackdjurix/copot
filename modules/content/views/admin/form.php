                    ...
                    <fieldset class="admin-content-form-section" data-media-picker data-picker-url="<?= htmlspecialchars($contentAdminUrl('media/context-picker'), ENT_QUOTES, 'UTF-8') ?>" data-upload-url="<?= htmlspecialchars($contentAdminUrl('media/context-picker/upload'), ENT_QUOTES, 'UTF-8') ?>" data-csrf-token="<?= htmlspecialchars($csrfToken ?? '', ENT_QUOTES, 'UTF-8') ?>">
                        ...
                        <dialog class="admin-media-picker" data-media-picker-dialog aria-labelledby="media-picker-title">
                            <div class="admin-media-picker__panel">
                                ...
                                <div class="admin-media-picker__prepare" data-media-picker-prepare hidden><p data-media-picker-prepare-status>Prepare featured image</p><div class="admin-media-picker__crop-frame" data-media-picker-crop-frame><img data-media-picker-crop-image alt="Crop preview" draggable="false"></div><div class="admin-media-picker__crop-controls"><label>Horizontal crop position<input type="range" min="0" max="100" value="50" data-media-picker-crop-x></label><label>Vertical crop position<input type="range" min="0" max="100" value="50" data-media-picker-crop-y></label></div><button type="button" class="admin-button admin-button--primary" data-media-picker-process>Confirm crop</button><button type="button" class="admin-button admin-button--secondary" data-media-picker-process-cancel>Cancel crop</button></div>
                                <div class="admin-actions"><button type="button" class="admin-button admin-button--secondary" data-media-picker-cancel>Cancel</button><button type="button" class="admin-button admin-button--primary" data-media-picker-confirm hidden disabled>Use selected Media</button></div>
                            </div>
                        </dialog>
                    </fieldset>
