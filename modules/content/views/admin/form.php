                    ...
                    <fieldset class="admin-content-form-section" data-media-picker data-picker-url="<?= htmlspecialchars($contentAdminUrl('media/context-picker'), ENT_QUOTES, 'UTF-8') ?>" data-upload-url="<?= htmlspecialchars($contentAdminUrl('media/context-picker/upload'), ENT_QUOTES, 'UTF-8') ?>" data-csrf-token="<?= htmlspecialchars($csrfToken ?? '', ENT_QUOTES, 'UTF-8') ?>">
                        ...
                        <dialog class="admin-media-picker" data-media-picker-dialog aria-labelledby="media-picker-title">
                            <div class="admin-media-picker__panel">
                                ...
                                <div class="admin-media-picker__prepare" data-media-picker-prepare hidden><p data-media-picker-prepare-status aria-live="polite">Prepare featured image</p><div class="admin-media-picker__crop-frame" data-media-picker-crop-frame role="img" tabindex="0" aria-label="Featured image crop viewport. Drag to position the 16:9 crop. Use arrow keys to nudge it."><img data-media-picker-crop-image alt="Crop preview" draggable="false"></div><input type="hidden" value="50" data-media-picker-crop-x><input type="hidden" value="50" data-media-picker-crop-y><label class="admin-media-picker__zoom">Crop zoom<input type="range" min="0" max="100" value="0" data-media-picker-crop-zoom aria-label="Crop zoom"></label><div class="admin-actions"><button type="button" class="admin-button admin-button--primary" data-media-picker-process>Confirm crop</button><button type="button" class="admin-button admin-button--secondary" data-media-picker-process-cancel data-media-picker-choose-another>Choose another</button></div></div>
