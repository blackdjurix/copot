...
final class ModulePackageOperator
{
    ...
    private function inspect(string $path): \Copot\Core\ModulePackageInspection { return (new ModulePackageIntakeInspector(new ZipIntakeService($this->app->path(), null, null, null, null, $this->app->installationIdentity()->value())))->inspect($path); }
