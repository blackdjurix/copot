...
$formRenderView = static function (string $view, array $data = []): string {
    if (!in_array($view, ['list', 'form'], true)) throw new RuntimeException('Form Admin view is unavailable.');
