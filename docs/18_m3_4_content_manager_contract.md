...
Remaining Batch 5 approval gates are this final documentation correction, its commit/push, final verification, and NRP confirmation. Release, tag, and publication remain outside Batch 5. Batch 6 and M3.R1 have separate future branches and lifecycles.
