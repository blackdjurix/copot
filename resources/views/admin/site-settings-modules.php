            ...
            <table class="admin-table site-settings-modules-table">
                ...
                <?php foreach ($items as $item): ?>
                    ...
                    <tr class="site-settings-module-row" data-site-settings-module-row data-detail-url="<?= $escape($detailPath($name)) ?>" data-filter-name="<?= $escape($searchIndex) ?>" data-filter-version="<?= $escape($versionFilter) ?>" data-filter-issue="<?= $escape($issueFilter) ?>" data-filter-status="<?= $escape($statusFilter) ?>" tabindex="0" aria-label="Open <?= $escape($title) ?> Module details">
                        <th scope="row" data-label="Module"><span class="site-settings-module-identity"><span class="admin-module-identity__title"><?= $escape($title) ?></span><span class="admin-module-identity__name"><code><?= $escape($name) ?></code></span><span class="site-settings-module-identity__status admin-badge <?= $escape($lifecycle[1]) ?>"><?= $escape($lifecycle[0]) ?></span></span></th>
                        ...
                        <td data-label="Status" class="site-settings-module-status-cell"><span class="admin-badge <?= $escape($lifecycle[1]) ?>"><?= $escape($lifecycle[0]) ?></span></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
