...
<head>
    ...
    <link rel="stylesheet" href="<?= htmlspecialchars(is_callable($url ?? null) ? $url('/admin-assets/css/admin.css?v=m311-wu3-acceptance-modules-5&rev=17') : '/admin-assets/css/admin.css?v=m311-wu3-acceptance-modules-5&rev=17', ENT_QUOTES, 'UTF-8') ?>">
