...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .builtin-site-content h1 { margin: 0 0 18px; color: #17202a; font-size: clamp(1.75rem, 4vw, 2.5rem); line-height: 1.08; }
        .builtin-site-content h1.builtin-site-page__title--article { font-size: 2rem; }
