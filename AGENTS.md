...
REQUIRED` for the reviewed M3.9 baseline. M3.10 Redirect Manager preparation
is LOCKED in `docs/26_m3_10_redirect_manager_contract.md`; WU1–WU3 are
COMPLETE on `feature/m3.10-redirect-manager`; the separate Admin Shell
design-adjustment checkpoint is required and not passed; WU4 is NOT STARTED.
