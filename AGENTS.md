...
M3.11 Form Manager preparation remains LOCKED. WU1–WU4 and full M3.11 are
COMPLETE on `feature/m3.11-form-manager`; the branch remains unreleased,
untagged, and unpublished. Deferred integrations remain excluded.
