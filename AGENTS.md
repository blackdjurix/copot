...
`NRP CONFIRMED`; WU6 implementation and focused validation are complete while
final human acceptance remains separate, and full M3.8 remains `NRP NOT REACHED`. Older M3.7 preparation
