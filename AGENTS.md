...
Internal Dashboard implementation is complete on the contained
`feature/m3.9-internal-dashboard` branch; WU1–WU4 are complete and the
Admin Shell design-adjustment checkpoint is `NO CHANGE REQUIRED` for the
current baseline. Integration to `main` remains separately authorized.
