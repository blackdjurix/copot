...
is LOCKED in `docs/26_m3_10_redirect_manager_contract.md`; WU1–WU2 are
COMPLETE on `feature/m3.10-redirect-manager`; WU3 is NEXT and WU4 is NOT
STARTED.
