...
foreach ([
    ...
    'modules/content/release.json',
    'modules/module-manager/module.json',
    'modules/module-manager/release.json',
    ...
    'modules/settings-manager/release.json',
    'modules/taxonomy/module.json',
    'modules/taxonomy/release.json',
    'modules/media/module.json',
    'modules/media/release.json',
    'modules/navigation/release.json',
    'modules/theme-manager/release.json',
    'modules/users-access/release.json',
    'modules/redirects/release.json',
    'modules/form-manager/release.json',
    'modules/users-access/module.json',
