...
try {
    ...
    $assert(str_contains($picker, 'data-media-picker-crop-y') && str_contains($picker, 'pointerdown') && str_contains($picker, 'cropY.value'), 'Two-dimensional crop positioning is missing.');
