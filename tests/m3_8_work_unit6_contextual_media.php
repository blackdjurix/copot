...
try {
    ...
    $assert(str_contains($picker, 'data-media-picker-crop-y') && str_contains($picker, 'data-media-picker-crop-width') && str_contains($picker, 'data-media-picker-crop-box') && str_contains($picker, 'pointerdown') && str_contains($picker, 'cropY.value') && !str_contains($picker, 'cropZoom') && !str_contains($picker, '1280'), 'Direct bounded crop-box positioning is missing or retains the quality minimum.');
