...
$assert(str_contains($articles, 'builtin-site-article-item__body p:not(.builtin-site-article-item__meta)') || str_contains($layout, 'builtin-site-article-item__body p:not(.builtin-site-article-item__meta)'), 'Article Collection excerpts are not italicized in the shared presentation.');
