...
$assert(str_contains($layout, "pageTypeValue") && str_contains($layout, "pageType === 'general'") && str_contains($layout, "pageType === 'homepage'") && str_contains($layout, 'aspect-ratio: 3 / 4') && str_contains($layout, 'border-radius: 0;'), 'Built-in Public View page taxonomy or responsive Homepage Hero presentation is missing.');
...
$assert(str_contains($layout, 'builtin-site-page-strip') && str_contains($layout, 'background: var(--builtin-main)') && !str_contains($layout, 'border-top: 4px solid var(--builtin-main)'), 'General Page strip boundary or Homepage strip removal is incorrect.');
