...
$assert(str_contains($layout, 'font-size: clamp(1.75rem, 4vw, 2.5rem)') && !str_contains($layout, 'font-size: clamp(2rem, 5vw, 3.25rem)'), 'Built-in Public View editorial title scale is not using the bounded responsive size.');
$assert(str_contains($layout, '.builtin-site-content h1.builtin-site-page__title--article { font-size: 2rem; }') && str_contains($contentView, 'builtin-site-page__title--article') && !str_contains($layout, 'border-bottom: 1px solid #d9e0e7'), 'Article title sizing or shared header seam correction is missing.');
...
$assert(strpos($contentView, 'builtin-site-breadcrumb') < strpos($contentView, '<h1') && strpos($contentView, '<h1') < strpos($contentView, 'builtin-site-page__intro') && strpos($contentView, 'builtin-site-page__intro') < strpos($contentView, 'builtin-site-page__meta') && strpos($contentView, 'builtin-site-page__meta') < strpos($contentView, 'builtin-site-featured-image') && strpos($contentView, 'builtin-site-featured-image') < strpos($contentView, '<div>'), 'General Page editorial blocks are not ordered Breadcrumb, H1, intro, metadata, featured image, body.');
