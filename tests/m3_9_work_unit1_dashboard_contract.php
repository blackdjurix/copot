...
namespace {
    ...
    $assert(str_contains($contract, 'feature/m3.9-internal-dashboard') && str_contains($contract, 'retained after the completed') && str_contains($contract, 'integrated into `main` by fast-forward'), 'M3.9 branch status is not recorded correctly.');
