...
namespace {
    ...
    $assert(str_contains($contract, 'feature/m3.9-internal-dashboard') && str_contains($contract, 'contained implementation'), 'M3.9 branch status is not recorded correctly.');
