...
`docs/31_backup_recovery_foundation_contract.md`; WU1, WU2, WU3, WU4, and WU5 are
complete, WU6 is complete, WU7 is not started, destructive rollback/restore
remains outside the delivered scope, and IU2 remains blocked pending the
