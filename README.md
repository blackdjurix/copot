...
Current M3.8 state: WU1–WU6 are accepted predecessors. The approved Content featured-Media picker, consumer-scoped
...
Media Manager visual refinement remains Deferred / Unscheduled and non-blocking. WU7 closure evidence covers the genuine pre-M3.8 upgrade path, five-action authorization, package inclusion, and packaged clean-install provisioning. Full M3.8 remains not complete.
...
complete on this branch. WU7 closure evidence is complete. Full M3.8 is not
complete. The contract is
