...
complete, WU6 is not started, destructive rollback/restore remains unavailable
until the remaining foundation work is accepted, and IU2 remains blocked
pending an accepted restore-capable implementation.
...
COMPLETE; WU3 COMPLETE; WU4 COMPLETE; WU5 COMPLETE; WU6 NOT STARTED.
