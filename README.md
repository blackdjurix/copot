...
final human acceptance remains separate, and full M3.8 remains `NRP NOT REACHED`. Older M3.7 preparation checkpoint statements
...
implementation and focused validation are complete on this branch; final human
acceptance remains separate. WU7 is not started and unauthorized. Full M3.8 is
