...
M3.11 Form Manager preparation remains LOCKED. WU1–WU3 are COMPLETE on
`feature/m3.11-form-manager`; M3.11 implementation is IN PROGRESS, WU4 is NOT
STARTED, and full M3.11 is NOT COMPLETE. WU3 adds only the protected Admin
submission workspace; public rendering and rate-limit persistence remain deferred.
